...
if(coin_lio_CONFIG_INCLUDED)
  return()
endif()
set(coin_lio_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(coin_lio_SOURCE_PREFIX /media/yzh/YZH2/Projects/SLAM_NOTED/coin-lio)
  set(coin_lio_DEVEL_PREFIX /media/yzh/YZH2/Projects/SLAM_NOTED/coin-lio/build/devel)
  set(coin_lio_INSTALL_PREFIX "")
  set(coin_lio_PREFIX ${coin_lio_DEVEL_PREFIX})
else()
  set(coin_lio_SOURCE_PREFIX "")
  set(coin_lio_DEVEL_PREFIX "")
  set(coin_lio_INSTALL_PREFIX /usr/local)
  set(coin_lio_PREFIX ${coin_lio_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'coin_lio' is deprecated")
...
set(coin_lio_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/media/yzh/YZH2/Projects/SLAM_NOTED/coin-lio/build/devel/include;/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(coin_lio_INCLUDE_DIRS "")
  set(_include_dirs "/media/yzh/YZH2/Projects/SLAM_NOTED/coin-lio/build/devel/include;/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'patripfr <patripfr@ethz.ch>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${coin_lio_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'coin_lio' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'coin_lio' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/yzh/YZH2/Projects/SLAM_NOTED/coin-lio/${idir}'.  ${_report}")
    endif()
    _list_append_unique(coin_lio_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND coin_lio_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND coin_lio_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT coin_lio_NUM_DUMMY_TARGETS)
      set(coin_lio_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::coin_lio::wrapped-linker-option${coin_lio_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR coin_lio_NUM_DUMMY_TARGETS "${coin_lio_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::coin_lio::wrapped-linker-option${coin_lio_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND coin_lio_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /media/yzh/YZH2/Projects/SLAM_NOTED/coin-lio/build/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(coin_lio_LIBRARY_DIRS ${lib_path})
      list(APPEND coin_lio_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'coin_lio'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND coin_lio_LIBRARIES ${lib})
    endif()
  endif()
...
set(coin_lio_EXPORTED_TARGETS "coin_lio_generate_messages_cpp;coin_lio_generate_messages_eus;coin_lio_generate_messages_lisp;coin_lio_generate_messages_nodejs;coin_lio_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${coin_lio_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 coin_lio_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${coin_lio_dep}_FOUND)
      find_package(${coin_lio_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${coin_lio_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(coin_lio_INCLUDE_DIRS ${${coin_lio_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(coin_lio_LIBRARIES ${coin_lio_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${coin_lio_dep}_LIBRARIES})
  _list_append_deduplicate(coin_lio_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(coin_lio_LIBRARIES ${coin_lio_LIBRARIES})

  _list_append_unique(coin_lio_LIBRARY_DIRS ${${coin_lio_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(coin_lio_EXPORTED_TARGETS ${${coin_lio_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "coin_lio-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${coin_lio_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
