...
bool Estimator::initialStructure()
{
    ...
    // doc: 将f_manager中的所有feature保存到存有SFMFeature对象的sfm_f中
    ...
    // doc: 保证具有足够的视差,由F矩阵恢复Rt
    // doc: 第l帧是从第一帧开始到滑动窗口中第一个满足与当前帧的平均视差足够大的帧，会作为参考帧到下面的全局sfm使用
    // doc: 此处的relative_R，relative_T为当前帧到参考帧（第l帧）的坐标系变换Rt
