# FLOAM 
## 算法解读
[FLOAM论文解读1](https://zhuanlan.zhihu.com/p/511585767)
[FLOAM代码解读1](https://github.com/Cc19245/FLOAM-CC_Comments)
[FLOAM代码解读2](https://github.com/FeiduoduoPeng/FloamReading/blob/master/src/lidarOptimization.cpp)

**个人总结:**
> 1. f-loam 是基于特征点的激光里程计, 这部分相对于 loam 多了加权；
> 
> 2. 该类方法往往需要较多的特征点, 从而导致lidar点云必须稠密, 在狭窄空间下容易失效, 比如楼梯；
